...
const StudentConnect = () => {
  return (
    <div className="flex min-h-screen bg-[#f8f9fb]">
      {/* Sidebar */}
      <aside className="w-[220px] bg-white border-r border-gray-200 p-6 flex flex-col justify-between">
        <div>
          <nav className="flex flex-col gap-4">
            ...
            <a href="#" className="text-gray-700">My Requests</a>
            <a href="#" className="text-gray-700">Profile</a>
          </nav>
        </div>
        <div>
          <a href="#" className="text-gray-500">Profile</a><br />
