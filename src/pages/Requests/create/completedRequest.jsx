...
const CompletedRequests = () => {
    ...
    // Load completed requests from Firestore with real-time updates
    useEffect(() => {
        if (!user?.id) return;
        ...
        const fetchRequests = async () => {
            try {
                ...
                // Query for user's completed requests
                ...
                console.error('Error setting up completed requests listener:', error);
                setLoading(false);
            }
        };
